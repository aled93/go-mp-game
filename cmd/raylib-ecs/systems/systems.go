...
var InertiaService = ecs.CreateSystemService(&inertiaController{})
var SpatialUpdateService = ecs.CreateSystemService(&spatialUpdateController{})
var ScreenWrapService = ecs.CreateSystemService(&screenWrapController{})
var GravityEmitterService = ecs.CreateSystemService(&gravityEmitController{})
var GravityReceiverService = ecs.CreateSystemService(&gravityReceiveController{})
